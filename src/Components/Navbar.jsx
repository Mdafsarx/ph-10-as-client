...
const Navbar = () => {
    ...
    const PageLink = <>
        ...
        <NavLink to={`/myArt&Craft/${user?.email}`}>My Art&Craft</NavLink>
    </>
            ...
            <div className="navbar  md:max-w-7xl mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu font-bold menu-sm dropdown-content mt-3 text-black z-50 p-2 shadow bg-base-100 rounded-box w-40">
                            {PageLink}
                        </ul>
                    </div>
