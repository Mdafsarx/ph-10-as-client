                ...
                <div className="w-full max-w-md p-8 space-y-1.5 md:rounded-xl bg-[#40F8FF] text-black ">
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        ...
                        <div className="space-y-0.5 text-sm">
                            ...
                            <input type="text" name="name" placeholder="Username" className="w-full px-4 py-3 rounded-md text-black" />
                        </div>


                        <div className="space-y-0.5 text-sm">
                            <label className="block ">Email</label>
                            <input type="text" name="email" placeholder="Email" className="w-full px-4 py-3 rounded-md text-black" />
                        </div>

                        <div className="space-y-0.5 text-sm">
                            <label className="block ">Photo url</label>
                            <input type="text" name="url" placeholder="URL" className="w-full px-4 py-3 rounded-md text-black" />
                        </div>
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="password" name="password" id="password" placeholder="Password" className="w-full text-black px-4 py-3 rounded-md dark:text-gray-800 focus:dark:border-violet-600" />
                        </div>
